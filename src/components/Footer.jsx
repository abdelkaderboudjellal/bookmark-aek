...
const Footer = () => {
  ...
  return (
    <div className="bg-[#252B46] text-white py-14 px-8 min-w-[420px] w-[100%]">
      <div className="flex justify-between">
        <div className=" md:flex md:justify-between md:items-center ">
          <div className="md:0 ml-24 ">
          ...
          <ul className=" md:flex  items-center ">
            {listname.map((list) => (
              <li key={list.id} className=" px-2 flex text-xl   hover:text-[#F87171] items-center">
                <Link
      ...
      <div className="md:flex items-center justify-center font-mono text-sm">
        <p>Challenge by</p>
        <a href="#" className="underline text-[#7892EF] px-2">
          Frontend Mentor.
        </a>
        <p> Coded by </p>
        <a
          href="mailto:kaderboudj94@gmail.com"
          className="underline text-[#7892EF] px-2"
        >
